// Polling endpoint (v2 handler). Frontend hits this every ~3s after
// calling research-compare; returns the current comparison job record,
// including the results array when status === "done".
...
export const config: Config = {
  path: "/.netlify/functions/research-compare-status",
};
