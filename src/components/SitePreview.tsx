    ...
    <div className="preview-wrap">
      <div className="preview-meta">
        ...
        <div style={{ marginTop: 12 }}>
          ...
          {site.claude_chat_url && (
            <div className="meta-row">
              <span className="lbl">Claude chat</span>
              <a
                href={site.claude_chat_url}
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "var(--accent)", textDecoration: "none" }}
                title="Reopen the original Claude.ai conversation that produced this site"
              >
                open ↗
              </a>
            </div>
